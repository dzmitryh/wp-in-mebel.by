...
<!-- BEGIN Comments -->	
	...
	<div class="comment-holder">
		<h3 class="comments-h"><span><?php printf( _n( theme_locals("response"), theme_locals("responses"), get_comments_number(), CURRENT_THEME ),
	...
	<h3><span><?php comment_form_title(theme_locals("leave_a_reply")); ?></span></h3>
