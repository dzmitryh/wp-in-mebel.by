...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '25px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));
								
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '22px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '18px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '46px', 'lineheight' => '48px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#392e31'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '21px', 'lineheight' => '25px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#3d3a38'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Roboto', 'style' => 'normal', 'character'  => 'latin', 'color' => '#979091'));
		return $options;
	}
}
?>
